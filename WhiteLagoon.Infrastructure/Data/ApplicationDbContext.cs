...
public class ApplicationDbContext : IdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        DateTime seedDate = new DateTime(2026, 01, 01, 0, 0, 0, DateTimeKind.Utc);
        ...
        var villas = new List<Villa>
        {
            new Villa
            {
                ...
                MeterSquared = 220,
                Occupancy = 6,
                ImageUrl = "/images/VillaImages/10875808-b728-427e-adda-f7af3d440eb4.jpg",
                CreatedAt = seedDate,
                UpdatedAt = seedDate
            },
            new Villa
            {
                ...
                Description =
                    "Nestled in the mountains, this rustic-chic villa offers fireplace warmth and forest trails.",
                Price = 320.50,
                MeterSquared = 180,
                Occupancy = 4,
                ImageUrl = "/images/VillaImages/f4f8af08-3a40-4ec6-be5f-f4c27a4d6c72.jpg",
                CreatedAt = seedDate,
                UpdatedAt = seedDate
            },
            new Villa
            {
                ...
                Description =
                    "Luxury meets comfort in this sun-drenched villa with tropical gardens and outdoor kitchen.",
                Price = 580.75,
                MeterSquared = 260,
                Occupancy = 8,
                ImageUrl = "/images/VillaImages/cc053911-6481-43cd-8ed7-5c81729482b4.jpg",
                CreatedAt = seedDate,
                UpdatedAt = seedDate
            },
            new Villa
            {
                ...
                MeterSquared = 140,
                Occupancy = 3,
                ImageUrl = "/images/VillaImages/51a31d12-18c4-4727-8a31-f14cfce149dc.jpg",
                CreatedAt = seedDate,
                UpdatedAt = seedDate
            },
            new Villa
            {
                ...
                MeterSquared = 200,
                Occupancy = 5,
                ImageUrl = "/images/VillaImages/bdad0648-9d64-4e4c-9579-abb192ab72ad.jpg",
                CreatedAt = seedDate,
                UpdatedAt = seedDate
            }
        };
