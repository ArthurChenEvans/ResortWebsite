...
namespace WhiteLagoon.Infrastructure.Migrations
{
    ...
    [Migration("20251214105848_removeIdentityForVillaNumber")]
    partial class removeIdentityForVillaNumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WhiteLagoon.Domain.Entities.Villa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(6672), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            Occupancy = 6,
                            Price = 450.0,
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7548), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7876), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            Occupancy = 4,
                            Price = 320.5,
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7877), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7879), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            Occupancy = 8,
                            Price = 580.75,
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7879), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7881), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            Occupancy = 3,
                            Price = 290.0,
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7881), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7883), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            Occupancy = 5,
                            Price = 410.25,
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 12, 14, 10, 58, 48, 162, DateTimeKind.Unspecified).AddTicks(7883), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
